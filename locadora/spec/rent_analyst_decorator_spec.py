...
class RentAnalystDecoratorSpec(unittest.TestCase):
    ...
    def it_creates_a_rent_request(self):
        ...
        an_client_decorator.decorate(self.a_person)
        self.a_rent_analyst_decorator.decorate(self.a_person)
        self.a_rent_analyst_decorator.create_rent_request(self.a_movie, self.an_client)
    ...
    def it_creates_a_rent(self):
        an_client_decorator = ClientDecorator()
        an_client_decorator.decorate(self.a_person)
        rent_request = RentRequest(self.a_movie, self.a_rent_analyst_decorator, self.an_client)
        self.a_rent_analyst_decorator.decorate(self.a_person)

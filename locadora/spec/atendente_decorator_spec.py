...
class AtendenteDecoratorSpec(unittest.TestCase):
    ...
    def it_creates_a_pedido(self):
        ...
        an_client_decorator.decorate(self.a_person)
        self.a_atendente_decorator.decorate(self.a_person)
        self.a_atendente_decorator.create_pedido(self.a_movie, self.an_client)
    ...
    def it_creates_a_aluguel(self):
        an_client_decorator = ClientDecorator()
        an_client_decorator.decorate(self.a_person)
        pedido = Pedido(self.a_movie, self.a_atendente_decorator, self.an_client)
        self.a_atendente_decorator.decorate(self.a_person)
        self.a_atendente_decorator.decorated.output_area[self.a_movie.name] = pedido
